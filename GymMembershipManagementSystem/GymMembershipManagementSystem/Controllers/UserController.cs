...
namespace GymMembershipManagementSystem.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "UserID,UserName,Password,IsStaff")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserID,UserName,Password,IsStaff")] User user)
        {
            if (ModelState.IsValid)
            {
